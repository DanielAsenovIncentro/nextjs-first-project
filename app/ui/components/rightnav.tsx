    ...
    return (
        <aside className="bg-dark-300 pr-2">
            <div className="flex flex-col bg-dark-200 h-full rounded-t-md">
                <Link href="/app" className="font-bold relative h-max mx-auto mt-7 mb-1 w-max flex flex-row items-center justify-center gap-3 transition duration-100 hover:brightness-110 hover:[&>img]:rotate-z-5">
